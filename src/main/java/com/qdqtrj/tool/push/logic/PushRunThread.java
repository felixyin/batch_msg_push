...
import com.qdqtrj.tool.push.logic.msgthread.BaseMsgThread;
import com.qdqtrj.tool.push.logic.msgthread.MsgSendThread;
import com.qdqtrj.tool.push.ui.component.TableInCellProgressBarRenderer;
            ...
            if (PushData.stoppedThreadCount.intValue() == PushData.threadCount) {
                if (!PushData.fixRateScheduling) {
                    ...
                    if (App.trayIcon != null) {
                        ...
                        App.trayIcon.displayMessage("BatchMsgPush", msgName + " 发送完毕！", TrayIcon.MessageType.INFO);
                    }
