...
public class UpdateDialog extends JDialog {
    ...
    public UpdateDialog() {
        ...
        buttonDownloadFromWeb.addActionListener(e -> {
            ...
            try {
                desktop.browse(new URI("https://github.com/rememberber/BatchMsgPush/releases"));
    ...
    public void downLoad(String newVersion) {
        ...
        ThreadUtil.execute(
                () -> {
                    String fileUrl = "http://download.zhoubochina.com/exe/BatchMsgPush-" + newVersion.replace("v_", "v") + "-x64-Setup.exe";
                    ...
                    File tempDir = new File(FileUtil.getTmpDirPath() + "BatchMsgPush");
                    if (!tempDir.exists()) {
                        tempDir.mkdirs();
                    }
