...
import com.qdqtrj.tool.push.logic.msgsender.*;
import com.qdqtrj.tool.push.ui.Init;
import com.qdqtrj.tool.push.ui.Consts;
import com.qdqtrj.tool.push.ui.dialog.*;
    ...
    public static void addListeners() {
        ...
        settingForm.getOutSideAtTipsLabel().addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                tipsBuilder.append("<h2>建议每天使用BatchMsgPush频率很高的时候可以使用此功能</h2>");
        ...
        settingForm.getManualAtTipsLabel().addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                tipsBuilder.append("<h2>建议仅在临时使用一次BatchMsgPush且使用时间不会很长的时候才使用</h2>");
